...
<div class="style_switcher">
    ...
    <div id="contentwrapper">
        <div class="main_content">
            ...
            </div><div id="sortable_panels">
                <div class="row">
                    <div class="tac col-sm-12 col-md-12">
                        <a href="javascript:void(0)" class="btn reset_layout btn-default btn-sm">Reset layout</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-4 col-md-4 dd_column">
                        <div class="w-box" id="w_sort01">
                            ...
                            <div class="w-box-content cnt_a">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam vehicula diam in lorem commodo tristique. Proin pellentesque odio et quam gravida non vehicula lectus viverra. Nunc in consequat dolor. Nam dui mi, porta id vulputate eu, rutrum a enim. Fusce condimentum auctor fermentum. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed id augue eget urna consequat interdum. Donec est odio, facilisis vitae mattis ac, commodo id risus
                            </div>
                    ...
                    <div class="col-sm-8 col-md-8 dd_column">
                    ...
                    <div class="col-sm-6 col-md-6 dd_column">
                        <div class="w-box" id="w_sort03">
                            <div class="w-box-header">
                                Lorem ipsum
                                <div class="pull-right">
                                    <span class="label label-info">jpg, gif, png, zip</span>
                                    <i class="icon-refresh" id="upload_refresh"></i>
                                </div>
                            </div>
                            <div class="w-box-content">
                                <div id="widget_upload" class="gebo-upload">
                        ...
                        <div class="w-box" id="w_sort04">
                            <div class="w-box-header">
                                ...
                                <div class="pull-right sort-disabled">
                                    <input name="wg" id="wg" class="input-medium form-control" placeholder="Search..." type="text">
                                </div>
                            </div>
                            <div class="w-box-content">
                                <table class="table table-striped table_vam no-th">
                                    <tbody><tr>
                                        <td><img alt="" src="http://placehold.it/40x40/efefef" class="thumbnail"></td>
                                        <td>Summer Throssell</td>
                                        <td><strong class="act-info">.22</strong></td>
                                        <td>23/08/2013</td>
                                    </tr>
                                    <tr>
                                        <td><img alt="" src="http://placehold.it/40x40/efefef" class="thumbnail"></td>
                                        <td>Anthony Pound</td>
                                        <td><strong class="act-info">.15</strong></td>
                                        <td>23/08/2013</td>
                                    </tr>
                                    <tr>
                                        <td><img alt="" src="http://placehold.it/40x40/efefef" class="thumbnail"></td>
                                        <td>Erin Church</td>
                                        <td><strong class="act-danger">.00</strong></td>
                                        <td>23/08/2013</td>
                                    </tr>
                                    <tr>
                                        <td><img alt="" src="http://placehold.it/40x40/efefef" class="thumbnail"></td>
                                        <td>Declan Pamphlett</td>
                                        <td><strong class="act-success">.84</strong></td>
                                        <td>23/08/2013</td>
                                    </tr>
                                    </tbody></table>
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-4 col-md-4 dd_column">
                        <div class="w-box" id="w_sort05">
                            ...
                            <div class="w-box-content cnt_a">
                                <div class="sepH_b">
                                    <label for="w_name">Username</label>
                                    <input name="w_name" id="w_name" class="form-control" type="text">
                                </div>
                                <div class="formSep">
                                    <label for="mail_message">Message</label>
                                    <textarea name="wg_message" id="wg_message" cols="10" rows="6" class="form-control auto_expand"></textarea>
                                </div>
                                <div class="clearfix">
                                    <a href="#" class="btn btn-gebo pull-right btn-default">Send</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4 col-md-4 dd_column">
                        <div class="w-box" id="w_sort06">
                            <div class="w-box-header">
                                Lorem ipsum
                                <div class="pull-right">
                            ...
                            <div class="w-box-content">
<pre class="prettyprint linenums">// turn a table row into a clickable link
                            ...
                            <div class="w-box-content cnt_a">
                                <div class="page-toolbar clearfix">
                                    <div class="btn-group pull-left">
                                        <a href="javascript:void(0)" class="btn toolbar-icon btn-default btn-sm"><i class="glyphicon glyphicon-file"></i></a>
                                        <a href="javascript:void(0)" class="btn toolbar-icon btn-default btn-sm"><i class="glyphicon glyphicon-pencil"></i></a>
                                        <a href="javascript:void(0)" class="btn toolbar-icon btn-default btn-sm"><i class="glyphicon glyphicon-print"></i></a>
                                        <a href="javascript:void(0)" class="btn toolbar-icon btn-default btn-sm"><i class="glyphicon glyphicon-remove"></i></a>
                                    </div>
                                    <div class="btn-group pull-right">
                                        <a href="javascript:void(0)" class="btn toolbar-icon btn-default btn-sm"><i class="glyphicon glyphicon-chevron-left"></i></a>
                                        <a href="javascript:void(0)" class="btn toolbar-icon btn-default btn-sm"><i class="glyphicon glyphicon-chevron-right"></i></a>
                                    </div>
                                </div>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla et tellus felis, sit amet interdum tellus. Suspendisse sit amet scelerisque dui. Vivamus faucibus magna quis augue venenatis ullamcorper. Proin eget mauris eget orci lobortis luctus ac a sem. Curabitur feugiat, eros consectetur egestas iaculis,
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla et tellus felis, sit amet interdum tellus. Suspendisse sit amet scelerisque dui. Vivamus faucibus magna quis augue venenatis ullamcorper. Proin eget mauris eget orci lobortis luctus ac a sem. Curabitur feugiat, eros consectetur egestas iaculis,
...
<!-- widgets functions -->
<script src="js/pages/gebo_widgets.js"></script>
